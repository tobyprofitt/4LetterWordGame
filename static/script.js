...
/**
 * Checks is the user is on a mobile device. Returns true if they are, false if not.
 */
...
// Typing listener for mobile. Only enable if they are on a mobile device.
isMobileDevice() && document.getElementById("hiddenMobileInput").addEventListener("input", function (event) {
